...
//
#ifndef BYPAOIN_BASE58_H
#define BYPAOIN_BASE58_H
...
template<typename K, int Size, CChainParams::Base58Type Type> class CIonExtKeyBase : public CBase58Data
{
public:
