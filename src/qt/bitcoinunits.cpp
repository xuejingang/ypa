...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("YPA");
    case mBTC: return QString("mYPA");
    case uBTC: return QString::fromUtf8("μYPA");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("YPAs");
    case mBTC: return QString("Milli-YPAs (1 / 1,000)");
    case uBTC: return QString("Micro-YPAs (1 / 1,000,000)");
    default: return QString("???");
    }
}
