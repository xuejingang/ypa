...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "YeePayssetsAssets.lnk";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        optionFile << "Name=YeePayssetsAssets\n";
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("YeePayssetsAssets-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  YeePayssetsAssets-Qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("YeePayssetsAssets-Qt"));
