...
If you want to build YeePayssetsAssets-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a YeePayssetsAssets-Qt executable will be
built by default.
...
2) The release is built with GCC and then "strip YeePayssetsAssetsd" to strip the debug
